USE oshop;
 ...
 ALTER TABLE tmp_position DROP PRIMARY KEY;  -- Sonst Probleme!
...
BEGIN
 ...
 OPEN curBestellung;             -- Jetzt wird der SELECT ausgefuehrt
 SET vEndeHaupt = 0;
 hauptschleife: LOOP             -- Start Hauptschleife
  ...
  INSERT INTO bestellung         -- Fuege die neue Bestellung ein
  ...
  innereschleife: LOOP           -- Start inneren Schleife
   ...
   INSERT INTO bestellung_position -- Position mit neuen Bestell-/Posnr
  ...
  END LOOP;                      -- Ende inneren Schleife
