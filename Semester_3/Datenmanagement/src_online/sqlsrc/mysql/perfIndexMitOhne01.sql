...
DROP DATABASE IF EXISTS perfIndexMitOhne01;
CREATE DATABASE perfIndexMitOhne01 CHARACTER SET utf8;

USE perfIndexMitOhne01;
...
-- Messung
DELIMITER //
CREATE PROCEDURE perfIndexMitOhne01
(
...
-- CALL perfIndexMitOhne01(100, 500);
